Profile: FHIRcastR4PatientOpen
Parent: Patient
Id: fhircast-r4-patient-open
Title: "FHIRcast R4 Patient for Open Events"
...
Instance: FHIRcastR4PatientOpen-Example
InstanceOf: FHIRcastR4PatientOpen
Usage: #example
Description: "Example of a patient which could be used in a [FHIR resource]-open event"
* id = "r4-503824b8-fe8c-4227-b061-7181ba6c3926"
