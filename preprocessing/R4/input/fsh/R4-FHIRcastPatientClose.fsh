Profile: FHIRcastR4PatientClose
Parent: Patient
Id: fhircast-r4-patient-close
Title: "FHIRcast R4 Patient for Close Events"
...
Instance: FHIRcastR4PatientClose-Example
InstanceOf: FHIRcastR4PatientClose
Usage: #example
...
* id = "r4-503824b8-fe8c-4227-b061-7181ba6c3926-close"
