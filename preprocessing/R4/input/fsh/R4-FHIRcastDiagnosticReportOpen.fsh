Profile: FHIRcastR4DiagnosticReportOpen
Parent: DiagnosticReport
Id: fhircast-r4-diagnostic-report-open
Title: "R4 FHIRcast Diagnostic Report for Open Events"
Description:
"""
...
Instance: FHIRcastR4DiagnosticReportOpen-Example
InstanceOf: FHIRcastR4DiagnosticReportOpen
Usage: #example
Description: "Example of an imaging study which could be used in a [FHIR resource]-open event"
* id = "r4-2402d3bd-e988-414b-b7f2-4322e86c9327"
