Profile: FHIRcastR4EncounterOpen
Parent: Encounter
Id: fhircast-r4-encounter-open
Title: "R4 FHIRcast Encounter for Open Events"
...
* subject 1..1
* subject only Reference(FHIRcastR4PatientOpen)
...
Instance: FHIRcastR4EncounterOpen-Example
InstanceOf: FHIRcastR4EncounterOpen
Usage: #example
Description: "Example of an encounter which could be used in a [FHIR resource]-open event"
* id = "r4-8cc652ba-770e-4ae1-b688-6e8e7c737438-r4"
