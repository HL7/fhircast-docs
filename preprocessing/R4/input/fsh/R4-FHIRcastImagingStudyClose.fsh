Profile: FHIRcastR4ImagingStudyClose
Parent: ImagingStudy
Id: fhircast-r4-imaging-study-close
Title: "FHIRcast R4 ImagingStudy for Close Events"
Description:
"""
...
* subject 1..1
* subject only Reference(FHIRcastR4PatientClose or Device or Group)
...
Instance: FHIRcastR4ImagingStudyClose-Example
InstanceOf: FHIRcastR4ImagingStudyClose
Usage: #example
...
* id = "r4-e25c1d31-20a2-41f8-8d85-fe2fdeac74fd-close"
