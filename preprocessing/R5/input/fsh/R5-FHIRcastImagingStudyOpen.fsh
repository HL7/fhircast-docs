Profile: FHIRcastR5ImagingStudyOpen
Parent: ImagingStudy
Id: fhircast-r5-imaging-study-open
Title: "FHIRcastR5 ImagingStudy for Open Events"
Description:
"""
...
* subject 1..1
* subject only Reference(FHIRcastR5PatientOpen or Device or Group)
...
Instance: FHIRcastR5ImagingStudyOpen-Example
InstanceOf: FHIRcastR5ImagingStudyOpen
Usage: #example
Description: "Example of an imaging study which could be used in a [FHIR resource]-open event"
* id = "r5-e25c1d31-20a2-41f8-8d85-fe2fdeac74fd"
