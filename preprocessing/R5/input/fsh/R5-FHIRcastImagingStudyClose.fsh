...
* subject 1..1
* subject only Reference(FHIRcastR5PatientClose or Device or Group)
...
Instance: FHIRcastR5ImagingStudyClose-Example
InstanceOf: FHIRcastR5ImagingStudyClose
Usage: #example
...
* id = "r5-e25c1d31-20a2-41f8-8d85-fe2fdeac74fd-close"
