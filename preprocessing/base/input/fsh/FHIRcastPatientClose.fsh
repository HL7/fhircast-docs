Profile: FHIRcast{{fhirNoUc}}PatientClose
Parent: Patient
Id: fhircast-{{fhirNoLc}}-patient-close
Title: "{{fhirNoUc}} FHIRcast Patient for Close Events"
...
(see also [FHIRcast Patient for Open Events](StructureDefinition-fhircast-{{fhirNoLc}}-patient-open.html)).
"""
* identifier 0..* MS
...
Instance: FHIRcast{{fhirNoUc}}PatientClose-Example
InstanceOf: FHIRcast{{fhirNoUc}}PatientClose
Usage: #example
...
* id = "{{fhirNoLc}}-503824b8-fe8c-4227-b061-7181ba6c3926-close"
