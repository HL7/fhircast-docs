...
Profile: FHIRcast{{fhirNoUc}}Observation
Parent: Observation
Id: fhircast-{{fhirNoLc}}-observation
Title: "{{fhirNoUc}} FHIRcast Observation"
Description: "Defines the minimum set of attributes which an application wanting to share observation content must support"
* subject 0..0
* hasMember MS
* derivedFrom MS

Instance: FHIRcast{{fhirNoUc}}Observation-Example
InstanceOf: FHIRcast{{fhirNoUc}}Observation
Usage: #example
Description: "Example of a simple observation which could be exchanged using FHIRcast"
* id = "{{fhirNoLc}}-435098234"
