Profile: FHIRcast{{fhirNoUc}}EncounterClose
Parent: Encounter
Id: fhircast-{{fhirNoLc}}-encounter-close
Title: "{{fhirNoUc}} FHIRcast Encounter for Close Events"
...
(see also [FHIRcast Encounter for Open Events](StructureDefinition-fhircast-{{fhirNoLc}}-encounter-open.html)).
"""
* identifier 0..* MS
...
* subject 1..1
* subject only Reference(FHIRcast{{fhirNoUc}}PatientClose)
...
Instance: FHIRcast{{fhirNoUc}}EncounterClose-Example
InstanceOf: FHIRcast{{fhirNoUc}}EncounterClose
Usage: #example
...
* id = "{{fhirNoLc}}-8cc652ba-770e-4ae1-b688-6e8e7c737438-close"
...
{{R4}} class = http://terminology.hl7.org/CodeSystem/v3-ActCode#NONAC
{{R4b}} class = http://terminology.hl7.org/CodeSystem/v3-ActCode#NONAC
