Profile: FHIRcast{{fhirNoUc}}DiagnosticReportClose
Parent: DiagnosticReport
Id: fhircast-{{fhirNoLc}}-diagnostic-report-close
Title: "{{fhirNoUc}} FHIRcast DiagnosticReport for Close Events"
...
[FHIRcast DiagnosticReport for Open Events](StructureDefinition-fhircast-{{fhirNoLc}}-diagnostic-report-open.html)).
"""
* identifier 0..* MS
...
Instance: FHIRcast{{fhirNoUc}}DiagnosticReportClose-Example
InstanceOf: FHIRcast{{fhirNoUc}}DiagnosticReportClose
Usage: #example
...
* id = "{{fhirNoLc}}-2402d3bd-e988-414b-b7f2-4322e86c9327-close"
