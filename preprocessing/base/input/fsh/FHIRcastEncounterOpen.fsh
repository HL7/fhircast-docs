Profile: FHIRcast{{fhirNoUc}}EncounterOpen
Parent: Encounter
Id: fhircast-{{fhirNoLc}}-encounter-open
Title: "{{fhirNoUc}} FHIRcast Encounter for Open Events"
...
[FHIRcast Encounter for Close Events](StructureDefinition-fhircast-{{fhirNoLc}}-encounter-close.html)).
"""
* identifier 1..*
...
Instance: FHIRcast{{fhirNoUc}}EncounterOpen-Example
InstanceOf: FHIRcast{{fhirNoUc}}EncounterOpen
Usage: #example
Description: "Example of an encounter which could be used in a [FHIR resource]-open event"
* id = "{{fhirNoLc}}-8cc652ba-770e-4ae1-b688-6e8e7c737438"
