Profile: FHIRcast{{fhirNoUc}}ImagingStudyOpen
Parent: ImagingStudy
Id: fhircast-{{fhirNoLc}}-imaging-study-open
Title: "{{fhirNoUc}} FHIRcast ImagingStudy for Open Events"
Description:
"""
...
[FHIRcast ImagingStudy for Close Events](StructureDefinition-fhircast-{{fhirNoLc}}-imaging-study-close.html)).
"""
* identifier 0..*
...
* subject 1..1
* subject only Reference(FHIRcast{{fhirNoUc}}PatientOpen or Device or Group)
...
Instance: FHIRcast{{fhirNoUc}}ImagingStudyOpen-Example
InstanceOf: FHIRcast{{fhirNoUc}}ImagingStudyOpen
Usage: #example
Description: "Example of an imaging study which could be used in a [FHIR resource]-open event"
* id = "{{fhirNoLc}}-e25c1d31-20a2-41f8-8d85-fe2fdeac74fd"
