Profile: FHIRcast{{fhirNoUc}}ImagingStudyClose
Parent: ImagingStudy
Id: fhircast-{{fhirNoLc}}-imaging-study-close
Title: "{{fhirNoUc}} FHIRcast ImagingStudy for Close Events"
Description:
"""
...
these business identifiers enables Subscribers to perform identity verification according to their requirements.  See [FHIRcast ImagingStudy for Open Events](StructureDefinition-fhircast-{{fhirNoLc}}-imaging-study-open.html)
...
[FHIRcast ImagingStudy for Open Events](StructureDefinition-fhircast-{{fhirNoLc}}-imaging-study-open.html)).
"""
* identifier 0..*
...
* subject 1..1
* subject only Reference(FHIRcast{{fhirNoUc}}PatientClose or Device or Group)
...
Instance: FHIRcast{{fhirNoUc}}ImagingStudyClose-Example
InstanceOf: FHIRcast{{fhirNoUc}}ImagingStudyClose
Usage: #example
...
* id = "{{fhirNoLc}}-e25c1d31-20a2-41f8-8d85-fe2fdeac74fd-close"
...
* subject = Reference(FHIRcast{{fhirNoUc}}PatientClose-Example)
