Profile: FHIRcast{{fhirNoUc}}DiagnosticReportOpen
Parent: DiagnosticReport
Id: fhircast-{{fhirNoLc}}-diagnostic-report-open
Title: "{{fhirNoUc}} FHIRcast Diagnostic Report for Open Events"
Description:
"""
...
(e.g., a [UUID](https://en.wikipedia.org/wiki/Universally_unique_identifier)).  
"""
* identifier 0..*
...
"""
* subject 1..1
* subject only Reference(FHIRcast{{fhirNoUc}}PatientOpen)
...
"""
{{R4}} imagingStudy ^short = "Imaging study (or studies) which are the subject of this report"
{{R4}} imagingStudy ^definition =
{{R4b}} imagingStudy ^short = "Imaging study (or studies) which are the subject of this report"
{{R4b}} imagingStudy ^definition =
{{R5}} study ^short = "Imaging study (or studies) which are the subject of this report"
{{R5}} study ^definition =
"""
...
Instance: FHIRcast{{fhirNoUc}}DiagnosticReportOpen-Example
InstanceOf: FHIRcast{{fhirNoUc}}DiagnosticReportOpen
Usage: #example
Description: "Example of an imaging study which could be used in a [FHIR resource]-open event"
* id = "{{fhirNoLc}}-2402d3bd-e988-414b-b7f2-4322e86c9327"
* status = http://terminology.hl7.org/fhir/ValueSet/diagnostic-report-status#unknown
* subject = Reference(FHIRcast{{fhirNoUc}}PatientOpen-Example)
...
{{R4}} imagingStudy = Reference(FHIRcast{{fhirNoUc}}ImagingStudyOpen-Example)
{{R4b}} imagingStudy = Reference(FHIRcast{{fhirNoUc}}ImagingStudyOpen-Example)
{{R5}} study = Reference(FHIRcast{{fhirNoUc}}ImagingStudyOpen-Example)
