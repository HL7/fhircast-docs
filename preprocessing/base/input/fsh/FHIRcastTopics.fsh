Instance: FHIRcast{{fhirNoUc}}ContainerTopicTopic
InstanceOf: SubscriptionTopic
* id =  "fhircast-{{fhirNoLc}}-container-update-topic"
* url = "http://hl7.org/fhir/uv/fhircast/{{fhirNoLc}}/SubscriptionTopic/container-update-topic"
* title = "{{fhirNoUc}} Subscribe to container changes in a topic"
* description = """
...
Instance: FHIRcast{{fhirNoUc}}ContainerResourceTopic
InstanceOf: SubscriptionTopic
* id = "fhircast-{{fhirNoLc}}-container-update-resource"
* url = "http://hl7.org/fhir/uv/fhircast/{{fhirNoLc}}/SubscriptionTopic/container-update-resource"
* title = "{{fhirNoUc}} Subscribe to container changes of an resource"
* description = """
