...
* subject 1..1
* subject only Reference(FHIRcastR4bPatientOpen or Device or Group)
...
Instance: FHIRcastR4bImagingStudyOpen-Example
InstanceOf: FHIRcastR4bImagingStudyOpen
Usage: #example
Description: "Example of an imaging study which could be used in a [FHIR resource]-open event"
* id = "r4b-e25c1d31-20a2-41f8-8d85-fe2fdeac74fd"
