Profile: FHIRcastR4bEncounterClose
Parent: Encounter
Id: fhircast-r4-encounter-close
Title: "FHIRcast R4b Encounter for Close Events"
...
Instance: FHIRcastR4bEncounterClose-Example
InstanceOf: FHIRcastR4bEncounterClose
Usage: #example
...
* id = "r4b-8cc652ba-770e-4ae1-b688-6e8e7c737438-close"
