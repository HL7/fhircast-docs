Profile: FHIRcastR4bEncounterOpen
Parent: Encounter
Id: fhircast-r4-encounter-open
Title: "FHIRcast R4b Encounter for Open Events"
...
* subject 1..1
* subject only Reference(FHIRcastR4bPatientOpen)
...
Instance: FHIRcastR4bEncounterOpen-Example
InstanceOf: FHIRcastR4bEncounterOpen
Usage: #example
Description: "Example of an encounter which could be used in a [FHIR resource]-open event"
* id = "r4b-8cc652ba-770e-4ae1-b688-6e8e7c737438"
