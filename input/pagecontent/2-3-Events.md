...
The key used for indicating a context change event's FHIR resource SHALL be the lower-case resourceType of the resource. The resources to include is defined in the corresponding event definition in the [standard event catalog](3_Events.html).
