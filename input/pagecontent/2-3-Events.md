...
New events are proposed in a prescribed format using the [documentation template](3-1-template.html) by submitting a [pull request](https://github.com/fhircast/docs/tree/master/docs/events). FHIRcast events are versioned, and mature according to the [Event Maturity Model](3-0-EventMaturityModel.html).
...
All events are documents in the [standard event catalog(3-Events.html)] and SHALL be defined in the following format.
