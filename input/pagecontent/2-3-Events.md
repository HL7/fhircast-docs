...
The key used for indicating an events' anchor FHIR resource SHALL be the lower-case resourceType of the resource. The resources to include is defined in the corresponding event definition in the [event catalog](3-Event.html).
