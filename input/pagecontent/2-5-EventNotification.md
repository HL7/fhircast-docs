...
4xx   | Other Client Error | For Subscriber errors other refusing to follow the context change; Subscribers can return other appropriate 4XX HTTP statuses. The Hub SHALL send a [`syncerror`](3-2-1-syncerror.html) indicating the event was refused.
